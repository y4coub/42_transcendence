...
export class GameControls {
	...
	private applyButtonStyles(
		...
		const variants: Record<'primary' | 'secondary' | 'warning' | 'danger', string> = {
			...
			secondary: 'border-[#00C8FF]/50 bg-[#121216] text-[#00C8FF] hover:bg-[#1a2432]',
	...
	private render(): void {
		...
		if (this.state.gameState === 'paused') {
			if (this.state.isUserPauser) {
				...
				disabledMessage.className = 'rounded border border-[#00C8FF]/20 bg-[#10121e]/70 px-4 py-2 text-xs uppercase tracking-[0.3em] text-[#E0E0E0]/60';
